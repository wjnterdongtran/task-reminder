    ...
    >
      <div className="w-full max-w-2xl bg-slate-900 rounded-2xl border border-slate-700/50 shadow-2xl max-h-[90vh] overflow-hidden flex flex-col animate-slideUp">
        ...
        <div className="p-6 border-b border-slate-700/50 flex items-start justify-between">
          <div className="flex-1">
            <div className="flex items-baseline gap-3 flex-wrap">
              ...
              {vocabulary.ipa && (
                <span className="text-slate-400">{vocabulary.ipa}</span>
              )}
            </div>
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
          {/* Meaning */}
          <div>
            <label className="text-sm text-cyan-400 font-medium uppercase tracking-wide flex items-center gap-2">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" />
              </svg>
              {t('vocabulary.meaning')}
            </label>
            <div className="mt-2 p-4 bg-slate-800/50 rounded-xl border border-slate-700/30">
              <p className="text-white whitespace-pre-wrap leading-relaxed">{vocabulary.meaning}</p>
            </div>
          </div>
          ...
          {vocabulary.usage && (
            <div>
              <label className="text-sm text-emerald-400 font-medium uppercase tracking-wide flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-2 p-4 bg-slate-800/50 rounded-xl border border-slate-700/30">
                <p className="text-slate-300 whitespace-pre-wrap leading-relaxed">{vocabulary.usage}</p>
              </div>
            </div>
          )}

          {/* Cultural Context */}
          {vocabulary.culturalContext && (
            <div>
              <label className="text-sm text-purple-400 font-medium uppercase tracking-wide flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="mt-2 p-4 bg-slate-800/50 rounded-xl border border-slate-700/30">
                <p className="text-slate-400 whitespace-pre-wrap leading-relaxed">{vocabulary.culturalContext}</p>
              </div>
            </div>
          )}
        </div>
