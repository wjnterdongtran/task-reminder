            ...
            <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        {needsAttention && (
                            <span className="shrink-0 inline-flex items-center gap-1 px-2.5 py-1 bg-rose-500/20 text-rose-300 text-xs font-bold rounded-full border border-rose-500/30 animate-pulse">
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-sm text-slate-400 mb-3">
                        ...
                        <span className="flex items-center gap-1">
                            ...
                            {task.lastRemindedAt
                                ? `${t(
                                      "taskItem.lastReminded"
                                  )} ${formatDistanceToNow(
                                      new Date(task.lastRemindedAt),
                                      { addSuffix: true }
                                  )}`
                                : `${t(
                                      "taskItem.created"
                    ...
                    {task.jiraId && (
                        <div className="flex items-center gap-2 mb-3">
                            ...
                            <button
                                ...
                                title={
                                    copiedJiraId ? "Copied!" : "Copy Jira ID"
                                }
                            >
                                {copiedJiraId ? (
                                    <svg
                        ...
                        <div className="mt-3">
                            ...
                            {isExpanded && (
                                <div className="mt-3 p-4 bg-slate-900/50 rounded-lg border border-slate-700/50 prose prose-sm prose-invert max-w-none">
                                    <ReactMarkdown>
                                        {preprocessMarkdown(task.description)}
                                    </ReactMarkdown>
                                </div>
                            )}
                        </div>
                ...
                <div className="flex flex-col gap-3 items-end shrink-0">
                    ...
                    {onTogglePin && (
                        <button
                         ...
                         ${
                            ...
                            title={
                                task.isPinned ? "Unpin task" : "Pin task to top"
                            }
                        >
                            <svg
                                className="w-4 h-4"
                    ...
                    >
                        <option value={TaskStatus.INIT}>
                            {getStatusLabel(TaskStatus.INIT)}
                        </option>
                        <option value={TaskStatus.WORKING}>
                            {getStatusLabel(TaskStatus.WORKING)}
                        </option>
                        <option value={TaskStatus.NEED_TAKING_CARE}>
                            {getStatusLabel(TaskStatus.NEED_TAKING_CARE)}
                        </option>
