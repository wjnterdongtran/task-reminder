            ...
            <div className="p-4">
                <div className="flex items-start gap-2 mb-2">
                    ...
                    <div
                        ...
                        {...listeners}
                        data-drag-handle
                        className="shrink-0 cursor-grab active:cursor-grabbing text-slate-500 hover:text-slate-300 transition-colors pt-0.5"
                        title="Drag to move"
                    >
                        <svg
                            className="w-4 h-4"
                    ...
                    {!task.isPinned && onTogglePin && (
                        <button
                            ...
                            className="shrink-0 text-slate-500 hover:text-amber-400 transition-colors opacity-0 group-hover:opacity-100"
                            title="Pin task"
                        >
                            <svg
                                className="w-4 h-4"
                    ...
                    {needsAttention && (
                        <span className="shrink-0 inline-flex items-center gap-1 px-2 py-1 bg-rose-500/20 text-rose-300 text-xs font-bold rounded-full border border-rose-500/30 animate-pulse">
                ...
                <div className="flex flex-wrap gap-2 text-xs text-slate-400 mb-3">
                    <span className="flex items-center gap-1">
                        ...
                        {formatDistanceToNow(new Date(task.createdAt), {
                            addSuffix: true,
                            locale: locale === "vi" ? undefined : undefined,
                        })}
                    </span>
                    {task.lastRemindedAt && (
