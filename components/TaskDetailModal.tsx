                    ...
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                {needsAttention && (
                                    <span className="shrink-0 inline-flex items-center gap-1 px-3 py-1.5 bg-rose-500/20 text-rose-300 text-sm font-bold rounded-full border border-rose-500/30 animate-pulse">
